...
const defaultData = {
  settings: {
    ...
    delivery_title: 'HOME DELIVERY AVAILABLE',
    delivery_text: 'Enjoy your favorite dishes delivered fresh to your doorstep. Delivery charges apply based on your location. Order now via WhatsApp or call us!',
